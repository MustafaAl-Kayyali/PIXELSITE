...
// Function to render crops into a given container
      ...
      if (isRare) {
        return `
                    <div class="card-item">
                        ...
                        <p><b>Trial Regions:</b> ${crop.trialRegions.join(
                          ", "
                        )}</p>
                    </div>
                `;
        ...
        return `
                    <div class="card-item">
                        ...
                        <p><b>Growing Region:</b> ${crop.growingRegion.join(
                          ", "
                        )}</p>
                        <p><b>Import Importance:</b> ${
                          crop.importImportance
                        }</p>
...
// Initial rendering of both sections
